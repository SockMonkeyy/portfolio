        ...
        $('.bs-button-wrap a').each(function() {
            $(this).mouseenter(function() {
                ...
                var buttonAnimation = anime.timeline({
                    ...
                    .add({
                        targets: parent.find('.circle-1').get(0),
                        translateX: -18,
                        translateY: 10,
                        offset: 0,
                        delay: 50,
                    ...
                    .add({
                        targets: parent.find('.circle-2').get(0),
                        translateX: -18,
                        translateY: 28,
                        offset: 0,
                        delay: 75,
                    ...
                    .add({
                        targets: parent.find('.circle-3').get(0),
                        translateX: -18,
                        translateY: 46,
                        offset: 0,
                        delay: 25,
                    ...
                    .add({
                        targets: parent.find('.circle-4').get(0),
                        translateX: -18,
                        translateY: 64,
                        offset: 0,
                        easing: 'easeInOutQuint'
                    ...
                    .add({
                        targets: parent.find('.circle-5').get(0),
                        translateX: -36,
                        translateY: 46,
                        offset: 0,
                        delay: 90,
                    ...
                    .add({
                        targets: parent.find('.circle-6').get(0),
                        translateX: 0,
                        translateY: -18,
                        offset: 0,
                        delay: 35,
                    ...
                    .add({
                        targets: parent.find('.circle-7').get(0),
                        translateX: 18,
                        translateY: -18,
                        offset: 0,
                        delay: 10,
                    ...
                    .add({
                        targets: parent.find('.circle-8').get(0),
                        translateX: 36,
                        translateY: -18,
                        offset: 0,
                        delay: 60,
                    ...
                    .add({
                        targets: parent.find('.circle-9').get(0),
                        translateX: 18,
                        translateY: -36,
                        offset: 0,
                        delay: 88,
                    ...
                    .add({
                        targets: parent.find('.circle-10').get(0),
                        translateX: 54,
                        translateY: -18,
                        offset: 0,
                        delay: 102,
                    ...
                    .add({
                        targets: parent.find('.circle-11').get(0),
                        translateX: 36,
                        translateY: 100,
                        offset: 0,
                        easing: 'easeInOutQuint'
                    ...
                    .add({
                        targets: parent.find('.circle-12').get(0),
                        translateX: 54,
                        translateY: 100,
                        offset: 0,
                        delay: 20,
                    ...
                    .add({
                        targets: parent.find('.circle-13').get(0),
                        translateX: 88,
                        translateY: -18,
                        offset: 0,
                        delay: 54,
                    ...
                    .add({
                        targets: parent.find('.circle-14').get(0),
                        translateX: 106,
                        translateY: -18,
                        offset: 0,
                        easing: 'easeInOutQuint'
                    ...
                    .add({
                        targets: parent.find('.circle-15').get(0),
                        translateX: 124,
                        translateY: -18,
                        offset: 0,
                        delay: 78,
                    ...
                    .add({
                        targets: parent.find('.circle-16').get(0),
                        translateX: 36,
                        translateY: 118,
                        offset: 0,
                        delay: 12,
                    ...
                    .add({
                        targets: parent.find('.circle-17').get(0),
                        translateX: 88,
                        translateY: -36,
                        offset: 0,
                        easing: 'easeInOutQuint'
                    ...
                    .add({
                        targets: parent.find('.circle-18').get(0),
                        translateX: -36,
                        translateY: 64,
                        offset: 0,
                        delay: 95,
                    ...
                    .add({
                        targets: parent.find('.circle-19').get(0),
                        translateX: -36,
                        translateY: 64,
                        offset: 0,
                        delay: 33,
                    ...
                    .add({
                        targets: parent.find('.circle-20').get(0),
                        translateX: -36,
                        translateY: 64,
                        offset: 0,
                        easing: 'easeInOutQuint'
    ...
    homepage: function() {
        if ($('.js-homepage')) {
            ...
            if ($(window).width() > 1005) {
                ...
                var splashScreen = anime.timeline({
                    loop: false
                });
...
function funZoneMouseInit() {
    ...
    function move() {
        ...
        path.attr({
            d: "M75,100 C88.8071187,100 100,88.8071187 100,75 C100,61.1928813 88.8071187,50 75,50 C61.1928813,50 50,61.1928813  " +
                tailPos +
